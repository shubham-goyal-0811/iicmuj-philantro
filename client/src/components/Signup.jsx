                ...
                <div className="login-form bg-white p-8 rounded shadow-2xl w-full max-w-md transition-all duration-500 ease-in-out transform hover:scale-105">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="password" id="confirmpassword" name="confirmpassword" value={formData.confirmpassword} required minLength="4" maxLength="20" onChange={handleChange}
                                className="mt-1 block w-full border-2 border-gray-900 rounded transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 hover:border-blue-500"style={{ padding: '2%' }}/>
                        </div>
                        <div className="mb-4">
                            <label htmlFor="picture" className="block text-gray-700">Upload ID Proof</label>
                            <input id="idProof" type="file" name="idProof" onChange={handleChange}
                        ...
                        <div className="mb-4 flex flex-col">
                            ...
                            <div className="inputs flex gap-4">
                                ...
                                <input type="radio" id="donorRadio" name="fav_language" value="Donor" onClick={handleFund2}
                                    className="transition-all duration-300 transform hover:scale-105"/>
                                <label htmlFor="picture" className="block text-gray-700">FundRaiser</label>
                                <input type="radio" id="FundRaiserRadio" name="fav_language" value="FundRaiser" onClick={handleFund}
                                    className="transition-all duration-300 transform hover:scale-105"/>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <button type="submit" className="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-300 duration-500 transform hover:scale-105" style={{ margin: '1%' }}>
                                Submit
                            </button>
                            <button type="button" className="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-300 duration-500 transform hover:scale-105" onClick={() => navigate('./Login')} style={{ margin: '1%' }}>
                                Already Exists?
                            </button>
                        </div>
                    </form>
